...
CREATE INDEX IF NOT EXISTS "idx_events_classification.identifier" ON events USING btree ("classification.identifier");
CREATE INDEX IF NOT EXISTS "idx_events_classification.taxonomy" ON events USING btree ("classification.taxonomy");
CREATE INDEX IF NOT EXISTS "idx_events_classification.type" ON events USING btree ("classification.type");
CREATE INDEX IF NOT EXISTS "idx_events_feed.code" ON events USING btree ("feed.code");
CREATE INDEX IF NOT EXISTS "idx_events_feed.name" ON events USING btree ("feed.name");
CREATE INDEX IF NOT EXISTS "idx_events_source.abuse_contact" ON events USING btree ("source.abuse_contact");
CREATE INDEX IF NOT EXISTS "idx_events_source.asn" ON events USING btree ("source.asn");
CREATE INDEX IF NOT EXISTS "idx_events_source.ip" ON events USING btree ("source.ip");
CREATE INDEX IF NOT EXISTS "idx_events_source.fqdn" ON events USING btree ("source.fqdn");
CREATE INDEX IF NOT EXISTS "idx_events_time.observation" ON events USING btree ("time.observation");
CREATE INDEX IF NOT EXISTS "idx_events_time.source" ON events USING btree ("time.source");
